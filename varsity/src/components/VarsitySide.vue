  ...
  export default {
    ...
    data() {
      return {
        pageInfo: {
          pageName: 'Varsity',
          apiUrl: ' https://summer-canyon-zh9zckabi5cf.vapor-farm-f1.com/api/varsities',
          permission: ''
        },
    ...
    methods: {
        ...
        const url = 'https://summer-canyon-zh9zckabi5cf.vapor-farm-f1.com/api/varsity-categories?per_page=10000&page=1'
      ...
      editItem(item) {
        ...
        this.selectedCategories = item.categories.map((el) => {
            return el.id
        })
